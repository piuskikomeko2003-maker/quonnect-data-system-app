...
export const LiveCounter: React.FC<LiveCounterProps> = ({
  ...
  return (
    <div className="bg-white border border-border rounded-xl shadow-xs p-3.5 sm:p-4 mb-6 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3.5 sm:gap-4 select-none">
      ...
      <div className="flex items-center justify-between sm:justify-start gap-2">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-bold text-emerald-700 flex items-center gap-1">
            <Radio className="w-3.5 h-3.5 animate-pulse shrink-0 text-emerald-600" />
        ...
        <div className="sm:hidden">
          <Button
            ...
            className="shrink-0 text-text-secondary hover:text-accent px-2 py-1 h-7 text-[11px]"
          >
      ...
      <div className="grid grid-cols-2 sm:flex sm:flex-wrap items-center gap-3 sm:gap-6 md:gap-8 flex-1 sm:justify-end sm:pr-2">
        ...
        <div className="text-left bg-slate-50 sm:bg-transparent p-2 sm:p-0 rounded-lg sm:rounded-none">
          ...
          <span className="text-base font-bold text-text-primary mt-0.5 block">
            <AnimatedNumber value={paidVendorsCount} />
          </span>
        </div>
        ...
        <div className="text-left bg-slate-50 sm:bg-transparent p-2 sm:p-0 rounded-lg sm:rounded-none">
          ...
          <span className="text-base font-bold text-text-primary mt-0.5 block">
            <AnimatedNumber value={walkinsCount} />
          </span>
        </div>

        {/* Field Data Collected progress */}
        <div className="col-span-2 sm:col-span-1 flex flex-col w-full sm:w-auto min-w-0 sm:min-w-[140px] sm:max-w-[200px] sm:flex-1 bg-slate-50 sm:bg-transparent p-2.5 sm:p-0 rounded-lg sm:rounded-none">
          <div className="flex justify-between items-center text-[9px] font-semibold text-text-tertiary uppercase tracking-wider mb-1 gap-1">
            ...
            <span className="text-accent font-bold shrink-0">{dataCollectedCount}/{totalPaidVendorsCount} ({dataCollectionPct}%)</span>
          </div>
