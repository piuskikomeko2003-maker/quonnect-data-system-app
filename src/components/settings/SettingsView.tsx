...
import { Users, DollarSign, Footprints, Settings as SettingsIcon } from 'lucide-react';
...
export const SettingsView: React.FC<SettingsViewProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'standard-fees' | 'walkin-estimates' | 'users'>('standard-fees');
