    ...
    <div className="space-y-6 text-left animate-fade-in">
      ...
      {loading ? (
        <div className="py-20 text-center">
          ...
          <p className="text-xs text-text-muted">Loading walk-in estimates...</p>
        </div>
      ) : items.length === 0 ? (
        <div className="py-16 text-center border border-dashed border-border rounded-xl bg-slate-50/50">
          ...
          <p className="text-xs text-text-muted mt-1">Create an edition in Markets & Editions to set its walk-in estimate.</p>
        </div>
      ) : (
                    ...
                    <tr key={item.id} className="hover:bg-slate-50/60 transition-colors">
                      ...
                      <td className="p-4 text-center">
                        <div className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-slate-100 border border-border rounded-lg text-text-secondary font-mono text-[11px]">
                          ...
                          <span className="font-bold text-text-primary">{item.loggedCount}</span>
                        </div>
                      </td>
                      <td className="p-4">
                        <div className="relative flex items-center">
                          <input
                            ...
                            className="w-full pl-3 pr-10 py-2 bg-slate-50 border border-border rounded-lg text-sm font-mono text-text-primary font-bold focus:bg-white focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-all"
                          />
                          <span className="absolute right-3 text-[11px] font-bold text-accent select-none">+</span>
                        </div>
                      </td>
